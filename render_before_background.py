...
parser.add_argument('--obj_name2', default=None, help="Second object name.")
...
mat1.set_principled_shader_value("Specular", random.uniform(0, 1))
...
if args.obj_name2 != None:
    ...
    mat2.set_principled_shader_value("Specular", random.uniform(0, 1))
