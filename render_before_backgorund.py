...
mat.set_principled_shader_value("IOR", random.uniform(0,1)) # TODO my creative addition
mat.set_principled_shader_value("Anisotropic", random.uniform(-1,1)) # TODO my creative addition
